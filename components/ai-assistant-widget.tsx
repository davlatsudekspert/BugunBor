...
import { ArrowRight, MessageCircleQuestion, Send, Sparkles, X } from 'lucide-react';
...
const faq: FaqEntry[] = [
  ...
  },
  {
    ...
    answer: 'Bog‘lanish sahifasidan yozing — moderatsiya har bir murojaatni ko‘rib chiqadi va javob beradi.',
    href: '/contact',
  ...
  function ask(question: string) {
    ...
    setMessages((current) => [
      ...
      match
        ...
        : { role: 'assistant', text: 'Bu savolga aniq javob topa olmadim. Bog‘lanish sahifasidan yozsangiz, jamoamiz tez orada javob beradi.', href: '/contact', linkLabel: 'Bog‘lanish' },
    ]);
    setInput('');
  }
