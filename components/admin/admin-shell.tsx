import { ClipboardList, CreditCard, Flag, Inbox, LayoutDashboard, Settings, ShieldCheck, Star, Store, Tags, Tag, Users } from 'lucide-react';

import type { Dictionary } from '@/lib/i18n';
import { cn } from '@/lib/utils';

export type AdminTab = 'overview' | 'businesses' | 'deals' | 'reviews' | 'reports' | 'users' | 'categories' | 'messages' | 'audit' | 'billing' | 'settings';
...
const tabs: Array<{ key: AdminTab; href: string; adminOnly: boolean; icon: typeof LayoutDashboard }> = [
  ...
  { key: 'reports', href: '/admin/reports', adminOnly: false, icon: Flag },
