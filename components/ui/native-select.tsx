...
type NativeSelectProps = Omit<React.ComponentProps<'select'>, 'size'> & {
  size?: 'sm' | 'default';
  /** Extra classes merged onto the <select> itself (e.g. a height matching a form's other
   * inputs) — `className` alone only reaches the positioning wrapper `<div>`, since the
   * chevron icon needs to sit inside that same wrapper. */
