...
export async function POST(request: Request) {
  ...
  const latitudeE6 = parsed.data.city === 'Samarqand' ? 39654200 : parsed.data.city === 'Buxoro' ? 39774200 : 41311200;
  ...
  await db.batch([
    ...
    db.prepare(`INSERT INTO branches(id, business_id, name, city, address, latitude_e6, longitude_e6, phone, working_hours_json)
      ...
      .bind(branchId, businessId, parsed.data.city, parsed.data.address, latitudeE6, longitudeE6, parsed.data.phone),
