...
| `/how-it-works`, `/faq`, `/contact`, `/terms`, `/privacy` | Information pages |
...
`/business` (landing and tariffs), `/business/onboarding`, `/business/dashboard`, `/business/redeem`, `/business/deals`, `/business/deals/new`, `/business/deals/[id]`, `/business/branches`, `/business/team`, `/business/profile`, `/business/billing`, `/business/switch/[id]` (choose the active business).
...
| `POST /admin` | Moderation and admin actions |
