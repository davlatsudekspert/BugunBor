  ...
  return {
    ...
    sections: [
      ...
      { id: 'collect', title: 'Qanday ma’lumot yig‘amiz', items: [
        ...
        'Profil: ko‘rinadigan ismingiz, profil rasmingiz (ixtiyoriy — faqat o‘zingiz qo‘ysangiz, uni faqat o‘zingiz ko‘rasiz), interfeys tili, Telegram xabarnomalari sozlamalari, oxirgi kirish vaqti, rozilik bergan vaqtingiz va siyosat tahriri.',
  ...
  return {
    ...
    sections: [
      ...
      { id: 'collect', title: 'Какие данные мы собираем', items: [
        ...
        'Профиль: отображаемое имя, фото профиля (по желанию — только если вы его добавите; его видите только вы), язык интерфейса, настройки уведомлений в Telegram, время последнего входа, время вашего согласия и версия политики.',
  ...
  return {
    ...
    sections: [
      ...
      { id: 'collect', title: 'What data we collect', items: [
        ...
        'Profile: display name, a profile photo (optional — only if you add one, and only you see it), interface language, Telegram notification settings, last sign-in time, the time of your consent and the policy version.',
